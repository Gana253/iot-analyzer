...
import com.java.relay42.exception.LoginAlreadyUsedException;
import com.java.relay42.repository.UserRepository;
import com.java.relay42.service.impl.UserService;
...
public class UserResource {
     ...
     */
    @GetMapping("/users/{login:" + IotConstants.LOGIN_REGEX + "}")
     ...
     */
    @DeleteMapping("/users/{login:" + IotConstants.LOGIN_REGEX + "}")
